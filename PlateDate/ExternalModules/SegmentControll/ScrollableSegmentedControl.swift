...
@objc public class ScrollableSegmentedControl: UIControl {
    ...
    override public var tintColor: UIColor! {
     ...
     var _segmentContentColor:UIColor?
    @objc public dynamic var segmentContentColor:UIColor? {
     ...
     var _selectedSegmentContentColor:UIColor?
    ...
    var selectedAttributes:[NSAttributedStringKey : Any]?
     var _titleAttributes:[UInt: [NSAttributedStringKey : Any]] = [UInt: [NSAttributedStringKey : Any]]()
    ...
    // MARK: - Private
     ...
     func calculateLongestTextWidth(text:String) {
    ...
    private class BaseSegmentCollectionViewCell: UICollectionViewCell {
        ...
        static let defaultFont = UIFont (name: "SourceSansPro-Bold", size: 15)
        static let defaultTextColor = UIColor._darkGray
